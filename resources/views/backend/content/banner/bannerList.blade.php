...
<script>
    ...
    var table 	= $('.datatable').DataTable( {
        ...
        "serverSide": true,
		"ajax": {
            "url": ServeUrl+"/banner/"+Instansi+"/list",
			"data": data,
        ...
        "columns": [
		 ...
		 "columnDefs": [ {
            ...
            "data": null,
			"orderable": false,
            "defaultContent": '<div class="icons-list"><div class="dropdown"><a href="#" class="list-icons-item" data-toggle="dropdown"><i class="icon-menu9"></i></a><div class="dropdown-menu dropdown-menu-right"><button id="open" class="dropdown-item"><i class="icon-folder-open3"></i> Open Detail</button><button id="edit" class="dropdown-item"><i class="icon-pencil7"></i> Edit</button><button id="delete" class="dropdown-item"><i class="icon-trash"></i> Delete</button><button id="lanjut" class="dropdown-item"><i class="icon-task"></i> Lanjutkan Halaman</button> </div></div></div>'
        },{
            "searchable": false,
            "orderable": false,
            "targets": 0,
	...
	$('#datatable-banner tbody').on( 'click', '#edit', function () {
		...
		window.location.href = BaseUrl+"/admin/bannerAds/update/"+data['id'];
    } );
	...
	function add(){
		window.location.href = BaseUrl+"/admin/bannerAds/add/"; 
	}
	...
	function remove(instansi, id){
	          swal({
				...
				$.ajax({
							data: "",
							url: ServeUrl+"/banner/"+instansi+"/delete/"+id,
							crossDomain: false,
							method: 'GET',
							complete: function(response){                
