...
.fixed-height{
 height: 460px;
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(33px, 16px, 0px);">
														<a href="{{url('admin/artikel')}}" class="dropdown-item"><i class="icon-list-unordered"></i> List Artikel</a>
														<a href="{{url('admin/artikel/add')}}" class="dropdown-item"><i class="icon-plus3"></i> Add Artikel</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
										...
										<div class="d-flex">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
						                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="icon-menu7"></i></a>
													<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(33px, 16px, 0px);">
														<a href="{{url('admin/kategori')}}" class="dropdown-item"><i class="icon-list-unordered"></i> List Kategori</a>
														<a href="{{url('admin/kategori/add')}}" class="dropdown-item"><i class="icon-plus3"></i> Add Kategori</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
										...
										<div class="d-flex">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
						                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="icon-menu7"></i></a>
													<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(33px, 16px, 0px);">
														<a href="{{url('admin/pages')}}" class="dropdown-item"><i class="icon-list-unordered"></i> List Pages</a>
														<a href="{{url('admin/pages/add')}}" class="dropdown-item"><i class="icon-plus3"></i> Add Page</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
										...
										<div class="d-flex">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
						                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="icon-menu7"></i></a>
													<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(33px, 16px, 0px);">
														<a href="{{url('admin/tags')}}" class="dropdown-item"><i class="icon-list-unordered"></i> List Tags</a>
														<a href="{{url('admin/tags/add')}}" class="dropdown-item"><i class="icon-plus3"></i> Add tag</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
										...
										<div class="d-flex">
											...
											<div class="list-icons ml-auto">
						                		<div class="list-icons-item dropdown">
						                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="icon-menu7"></i></a>
													<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(33px, 16px, 0px);">
														<a href="{{url('admin/upload')}}" class="dropdown-item"><i class="icon-list-unordered"></i> List Files</a>
														<a href="{{url('admin/upload/add')}}" class="dropdown-item"><i class="icon-plus3"></i> Add File</a>
													</div>
						                		</div>
					                		</div>
					                	</div>
	...
	$('.file-input-ajax').fileinput({
            browseLabel: 'Browse',
            uploadUrl: ServeUrl+"/slider/"+Instansi+"/create", // server upload action
            uploadAsync: true,
            showUpload: false,
            maxFileCount: 3,
            initialPreview: [],
	...
	function loadHome(){
		$.ajax({
					data: "",
					url: ServeUrl+"/home/"+Instansi+"/list",
                    method: 'GET',
	...
	function loadData(){
		...
		$.ajax({
					data: "",
					url: ServeUrl+"/slider/"+Instansi+"/list",
                    method: 'GET',
                    complete: function(response){                
                        if(response.status == 200){
	...
	function loadPost(){
		$.ajax({
					data: "",
					url: ServeUrl+"/artikel/"+Instansi+"/list",
                    method: 'GET',
                    complete: function(response){                
                        if(response.status == 200){
							var tbody = '';
							$.each(response.responseJSON.data.data, function(k,v){
								...
								tbody +='<img src="'+v.img_thumb+'" class="img-fluid img-preview rounded" alt=""><span class="card-img-actions-overlay card-img"><i class="icon-play3 icon-2x"></i></span></a>';
								tbody +='</div></div>';
								tbody +='<div class="media-body">';
								tbody +='<h6 class="media-title"><a href="#">'+v.judul_artikel+'</a></h6>';
	...
	function remove(){
		...
		swal({
				...
				$.ajax({
							data: '',
							url: ServeUrl+"/slider/"+Instansi+"/delete/" +id,
							method: 'DELETE',
							complete: function(response){                
