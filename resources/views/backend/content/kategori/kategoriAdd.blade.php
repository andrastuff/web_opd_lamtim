							...
							<div class="row">
								<div class="col-md-7">
									...
									<div class="form-group row">
										...
										<div class="col-lg-8">
										<input type="text" id="kategori" name="kategori" class="form-control" placeholder="Nama Kategori" value=""/>
									...
									<div class="form-group row">
										...
										<div class="form-check form-check-inline">
											<label class="form-check-label">
												<input type="radio" class="form-check-input" name="status" value="unpublished" checked="">
												Unpublished
											</label>
										</div>
										<i class="small"> </i>
...
<script> 
	$("#form-category").submit(function(event) {
		...
		if($.isNumeric(id)){
			var path = ServeUrl+"/kategori/"+Instansi+"/update/"+id;
		}else{
			var path = ServeUrl+"/kategori/"+Instansi+"/create";
		}
				$.ajax({
							data       : data,
							url        : path,
	...
	function loadView(){
		...
		$.ajax({
					data: "",
					url: ServeUrl+"/kategori/"+Instansi+"/view/"+id,
                    crossDomain: false,
                    method: 'GET',
                    complete: function(response){ 				
